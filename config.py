...
LOGGER_ID = int(getenv("LOGGER_ID", -1003515411667))
OWNER_ID = int(getenv("OWNER_ID", 7957361876))
...
# Support
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/elevenyts")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/elevenytsmusic")
